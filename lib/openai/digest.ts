...
export default async function handler(
    ...
    const ad = { title: "Wish Text Composer", url: "https://www.wish-text.com/landing?utm_content=am1news", 
    ...
    Whether it's birthdays, graduations, holidays, or moments of illness or loss, <a href="https://wish-text.com/landing?utm_contnet=embed-digest">WISH-TEXT.COM</a> provides personalized messages and thoughtful gift recommendations at no cost.  Try it today!`, publication:'wish-text.com', image: 'https://ucarecdn.com/478cc99f-1fd7-4a2b-804b-32ebafcd1555/wtad3.png', slug: 'wish-text-ad' };
    ads.push(ad);       
    let html = ''
    let json: any = {}
    if (ads.length > 0) {
