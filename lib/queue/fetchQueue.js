...
export async function fetchQueue({
    ...
    console.log(chalk.yellow.bold("fetchQueue forum:"), newsline,forum);
    ...
    async function innerFunctionNewsline(key, debugStr) {
        ...
        let chunkRange = async function (start, end) {
           ...
           // console.log(chalk.red.bold("Newsline:"), "After chunkRange", { key,range,start,end });
        ...
        if (!lastid || lastid == 0) {
           ...
           //  console.log("inside recurse setup start=",start);
            try {
               ...
               // l(chalk.green("range returned",js(range),range.length))
                   ...
                   // l('moving')
                    for (var i = 0; i < 100; i++) {
                        ...
                        if (+range[i] == lastid) {
                           ...
                           // console.log("*** *** *** MATCHED LASTID",lastid,i,key)
                            break;
                        }
                        else {
